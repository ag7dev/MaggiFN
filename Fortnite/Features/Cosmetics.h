    ...
    bool bUseMat = false, FString RequestedMat = FString(L"None"))
{
    ...
    {
        uint8_t Pad_0[0x0130]; 
    };

    FFortAthenaLoadout CosmeticLoadoutPC{};
    *(bool*)(uintptr_t(&CosmeticLoadoutPC) + 0x00C8) = true; 
    *(bool*)(uintptr_t(&CosmeticLoadoutPC) + 0x00C9) = true; 
            ...
            if (!Object) {
                ...
                *(UObject**)(uintptr_t(&CosmeticLoadoutPC) + 0x48) = Object; 
                ...
                for (int j = 0; j < CustomizationInfo.Size(); j++) {
                    ...
                    CharacterVariantChannel.VariantChannelTag = ChannelTag; 
                    CharacterVariantChannel.ActiveVariantTag = ActiveTag; 
                    ...
                    CharacterVariantChannel.CustomData = *reinterpret_cast<FString*>(uintptr_t(&CustomizationInfo[j]) + 0x8); 
                    CharacterVariantChannel.OwnedVariantTags = Fgg; 
    ...
    bool bUseMat = false, FString RequestedMat = FString(L"None"))
{
    ...
    if (BackblingName != L"") {
        ...
        *(UObject**)(uintptr_t(&CosmeticLoadoutPC) + 0x60) = UObject::FindObjectSingle<UObject*>(Cwbajs.c_str()); 
    }
    if (GliderName != L"") {
        ...
        *(UObject**)(uintptr_t(&CosmeticLoadoutPC) + 0x38) = UObject::FindObjectSingle<UObject*>(Glasidswjd.c_str()); 
    }
    if (SkyDiveContrailName != L"") {
        ...
        *(UObject**)(uintptr_t(&CosmeticLoadoutPC) + 0x30) = UObject::FindObjectSingle<UObject*>(Ciqaiskqi.c_str()); 
    }
    if (PickaxeName != L"")
    {
        ...
        *(UObject**)(uintptr_t(&CosmeticLoadoutPC) + 0x40) = UObject::FindObjectSingle<UObject*>(pixlers.c_str()); 
    }

   

    
    *(bool*)(uintptr_t(&CosmeticLoadoutPC) + 0x00C8) = false; 
    *(bool*)(uintptr_t(&CosmeticLoadoutPC) + 0x00C9) = true; 
