...
namespace Settings::Developer
{
	...
	int KickType = 1;
	int	DesyncV2Angle = 0;
	FString KickString = (FString)L"maggi";
}
...
namespace Settings::Developer::UIKit
{
	...
	bool ShowNewMaggiPrivateTitle = true;
...
namespace Settings::Skins
{
	...
	namespace Cosmetics
	{
		...
		std::wstring BurgerKingGuy = L"CID_035_Athena_Commando_M_Medieval"; 
		std::wstring ChinkSkin = L"CID_313_Athena_Commando_M_KpopFashion";
		
		std::wstring Galaxy = L"CID_175_Athena_Commando_M_Celestial"; 
		std::wstring YourDad = L"CID_636_Athena_Commando_M_GalileoGondola_78MFZ"; 
...
{
	FLinearColor RainbowChamsColorUWU = FLinearColor(1.f, 1.f, 0.f, 1.f); 
