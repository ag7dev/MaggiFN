...
namespace Framework
{
	...
	public:
		...
		void TabsTest(const wchar_t* names[], int array_size, int* tab)
		{
			...
			double tab_width = ((this->Size.X - 4) / tab_count) + 15.0; 
		...
		bool CreateMenu()
		{
			...
			static auto Enc_WataMark = Encrypt(L"Maggi Free - discord.gg/Maggicommunity - t.me/Maggicommunity");
			static FString WaltaMark = FString(Enc_WataMark.decrypt()); 
